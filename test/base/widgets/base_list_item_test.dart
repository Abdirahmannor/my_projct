...
import '../../../lib/core/base/base_list_item.dart';
...
// Create mock implementation of BaseListItem
class MockListItem extends BaseListItem<MockItem> {
  const MockListItem({
    super.key,
    required super.item,
